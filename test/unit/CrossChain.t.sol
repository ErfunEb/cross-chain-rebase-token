...
contract CrossChain is Test {
    ...
    function setUp() public {
        string memory SEPOLIA_ETH_RPC_ENDPOINT = vm.envString(
            "SEPOLIA_ETH_RPC_ENDPOINT"
        );
        string memory ARBITRUM_SEPOLIA_RPC_ENDPOINT = vm.envString(
            "ARBITRUM_SEPOLIA_RPC_ENDPOINT"
        );
        sepoliaFork = vm.createSelectFork(SEPOLIA_ETH_RPC_ENDPOINT);
        arbSepoliaFork = vm.createFork(ARBITRUM_SEPOLIA_RPC_ENDPOINT);
